...
import { lanType, lans } from "../utils/dropdownTypes";
import { useState } from "react";



export default function Header() {
  const [lan, setLan] = useState<lanType>("中文简体");
